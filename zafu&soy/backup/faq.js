...
return <Legal>
    ...
    <LegalText>
      ...
      <div className="accordion">
        <button className="accordion__button">
          <svg viewBox="0 0 67 63" fill="none" className="ceramic">
      ...
      <div className="accordion">
        <button className="accordion__button">
          <svg viewBox="0 0 69 71" fill="none" className="daruma">
      ...
      <div className="accordion">
        <button className="accordion__button">
          <svg viewBox="0 0 67 70" fill="none" className="kimono">
      ...
      <div className="accordion">
        <button className="accordion__button">
        <svg viewBox="0 0 78 73" fill="none" className="origami">
      ...
      <div className="accordion">
        <button className="accordion__button">
          <svg viewBox="0 0 67 71" fill="none" className="sake">
      ...
      <div className="accordion">
        <button className="accordion__button">
          <svg viewBox="0 0 75 68" fill="none" className="sushi">
